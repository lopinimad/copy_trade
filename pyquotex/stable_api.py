...
class Quotex:
    ...
    def __init__(
            ...
            user_agent = "Mozilla/5.0 (Linux 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36",
            root_path=".",
    ...
    async def test_connect():
        ...
        if global_value.check_websocket_if_error == 1:
            return False
    ...
    def orders_opened(self):
        """Get opened orders"""
        self.api.get_orders_open()
        time.sleep(0.2)
        return self.api.orders_opened_list
