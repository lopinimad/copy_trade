...
class WebsocketClient(object):
    ...
    def on_message(self, wss, message):
        ...
        try:
            ...
            elif self.api._temp_status == """451-["orders/opened/list",{"_placeholder":true,"num":0}]""":
                print(type(message),len(message),message + " 451-['orders/opened/list',{'_placeholder':true,'num':0}]")
                self.api.orders_opened_list = message
                #self.api.orders_opened_list[message["asset"]] = message
                self.api._temp_status = ""
            elif self.api._temp_status == """451-["s_orders/opened/list",{"_placeholder":true,"num":0}]""":
                print(type(message),len(message),message + " 451-['s_orders/opened/list',{'_placeholder':true,'num':0}]")
                self.api.orders_opened_list = message
                #self.api.orders_opened_list[message["asset"]] = message
                self.api._temp_status = ""
