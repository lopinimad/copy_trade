...
class QuotexAPI(object):
    ...
    def get_orders_open(self):
        """Method to get opened orders."""
        try:
            data = f'42["orders/opened/list"]'
            self.send_websocket_request(data, no_force_send=False)
        except:
            pass
        try:
            payload = {
            ...
            data = f'451-["orders/opened/list", {json.dumps(payload)}]'
            self.send_websocket_request(data, no_force_send=False)
        except:
            pass
        try:
            ...
            data = f'451-["s_orders/opened/list", {json.dumps(payload)}]'
            self.send_websocket_request(data,no_force_send=False)
        except:
            pass
        try:
    ...
    def send_http_request_v1(
        ...
        self.browser.headers["Accept-Encoding"] = "gzip, deflate, br, zstd"
        self.browser.headers["Accept-Language"] = "en-US,en;q=0.8"
        ...
        self.browser.headers["Sec-Ch-Ua"] = '"Not)A;Brand";v="8", "Chromium";v="138", "Brave";v="138"'
        ...
        self.browser.headers["sec-gpc"] = "1"
    ...
    async def authenticate(self):
        ...
        print(str(Timen) + " Connecting User Account ...")
    ...
    async def start_websocket(self):
        ...
        while True:
            if global_value.check_websocket_if_error:
                #print(str(global_value.websocket_error_reason) + " piko.")
                #if "getaddrinfo failed" in str(global_value.websocket_error_reason):
                return False, global_value.websocket_error_reason
            elif global_value.check_websocket_if_connect == 0:
                logger.debug("Websocket connection closed.")
                return False, str(Timen) + " Websocket connection closed."
            elif global_value.check_websocket_if_connect == 1:
                logger.debug("Websocket connected successfully!!!")
                return True, str(Timen) + " Websocket connected successfully!!!"
            elif global_value.check_rejected_connection == 1:
                global_value.SSID = None
                logger.debug("Websocket Token Rejected.")
                return True, str(Timen) + " Websocket Token Rejected."
